...
public class Info extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("VersusTournament Beta v1.0\n- Adicion de la posibilidad de organizar torneo de 3 a 16 participantes\n- Adicion de la Pestaña \"Torneo en Arbol para 6 articipantes\"\n- Adicion de la Pestaña \"Torneo en Arbol para 10 articipantes\"\n- Adicion de la Pestaña \"Torneo en Arbol para 12 articipantes\"\n- Adicion de la Pestaña \"Torneo en Arbol para 14 articipantes\"\n- Adicion de la Pestaña \"Info\"\n- Cambio de diseño en General\n- Optimización de el software para marcar los ganadores de la Ronda en curso\n\n\n----------------------------------------------------------------\nVersusTournament Alfa v0.1\n\n- Adicion de la pestaña de \"Añadir Participantes\"\n- Adicion de la Pestaña \"Torneo en Arbol para 4 articipantes\"\n- Adicion de la Pestaña \"Torneo en Arbol para 8 articipantes\"\n- Adicion de la Pestaña \"Torneo en Arbol para 16 articipantes\"");
